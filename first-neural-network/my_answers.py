...
class NeuralNetwork(object):
    ...
    def forward_pass_train(self, X, weights_input_to_hidden):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        delta_weights_i_h += np.dot(output_error_term, hidden_outputs)
        # Weight step (hidden to output)
        delta_weights_h_o += np.dot(hidden_error_term, X[:,None])
